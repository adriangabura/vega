...
def test_get_bucket(default_test_bucket, boto3_default_resource, boto3_default_client):
    bucket = boto_mapper.BucketOperation.get(boto3_default_resource, boto3_default_client, default_test_bucket.name)
...
def test_create_and_teardown_bucket(boto3_default_resource, boto3_default_session, boto3_default_client):
