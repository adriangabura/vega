...
#
#
# def create_super_user(sqlite_session_factory, fastapi_test_client: "TestClient"):
...
#
#     fastapi_test_client.put("/roles/policies/users_admin", auth=('root', 'default_password'))
